{
  description = "EasyTPA — Paper & Spigot teleport requests — Kotlin + HikariCP";
      ...
      in
      {
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            ...
            echo "EasyTPA — java $(java -version 2>&1 | head -n1) | gradle $(gradle --version | grep Gradle)"
            echo "  gradle shadowJar        → build/libs/easytpa-1.0.0.jar (Paper & Spigot)"
            ...
            echo "  IDEA: nix develop -c idea . &  |  nix run .#idea"
          '';
        };
